...
void aes_set_key( aes_context *ctx, uchar *key, uint keysize )
{
    ...
    case 14:
        ...
        for( i = 0; i < 7; i++, RK += 8 )
        {
            ...
            RK[12] = RK[4] ^
                        ( FSb[ (uchar) ( RK[11] >> 24 ) ] << 24 ) ^
                        ( FSb[ (uchar) ( RK[11] >> 16 ) ] << 16 ) ^
                        ( FSb[ (uchar) ( RK[11] >>  8 ) ] <<  8 ) ^
                        ( FSb[ (uchar) ( RK[11]       ) ]       );
...
{                                               \
    RK += 4;                                    \
                                                \
    X0 = RK[0] ^ RT0[ (uchar) ( Y0 >> 24 ) ] ^  \
                 RT1[ (uchar) ( Y3 >> 16 ) ] ^  \
                 RT2[ (uchar) ( Y2 >>  8 ) ] ^  \
                 RT3[ (uchar) ( Y1       ) ];   \
                                                \
    X1 = RK[1] ^ RT0[ (uchar) ( Y1 >> 24 ) ] ^  \
                 RT1[ (uchar) ( Y0 >> 16 ) ] ^  \
                 RT2[ (uchar) ( Y3 >>  8 ) ] ^  \
                 RT3[ (uchar) ( Y2       ) ];   \
                                                \
    X2 = RK[2] ^ RT0[ (uchar) ( Y2 >> 24 ) ] ^  \
                 RT1[ (uchar) ( Y1 >> 16 ) ] ^  \
                 RT2[ (uchar) ( Y0 >>  8 ) ] ^  \
                 RT3[ (uchar) ( Y3       ) ];   \
                                                \
    X3 = RK[3] ^ RT0[ (uchar) ( Y3 >> 24 ) ] ^  \
                 RT1[ (uchar) ( Y2 >> 16 ) ] ^  \
                 RT2[ (uchar) ( Y1 >>  8 ) ] ^  \
                 RT3[ (uchar) ( Y0       ) ];   \
}
    ...
    X0 = RK[0] ^ ( RSb[ (uchar) ( Y0 >> 24 ) ] << 24 ) ^
                 ( RSb[ (uchar) ( Y3 >> 16 ) ] << 16 ) ^
                 ( RSb[ (uchar) ( Y2 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (uchar) ( Y1       ) ]       );

    X1 = RK[1] ^ ( RSb[ (uchar) ( Y1 >> 24 ) ] << 24 ) ^
                 ( RSb[ (uchar) ( Y0 >> 16 ) ] << 16 ) ^
                 ( RSb[ (uchar) ( Y3 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (uchar) ( Y2       ) ]       );

    X2 = RK[2] ^ ( RSb[ (uchar) ( Y2 >> 24 ) ] << 24 ) ^
                 ( RSb[ (uchar) ( Y1 >> 16 ) ] << 16 ) ^
                 ( RSb[ (uchar) ( Y0 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (uchar) ( Y3       ) ]       );

    X3 = RK[3] ^ ( RSb[ (uchar) ( Y3 >> 24 ) ] << 24 ) ^
                 ( RSb[ (uchar) ( Y2 >> 16 ) ] << 16 ) ^
                 ( RSb[ (uchar) ( Y1 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (uchar) ( Y0       ) ]       );
